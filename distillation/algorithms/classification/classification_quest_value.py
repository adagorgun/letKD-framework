...
def object_classification_with_quest(
    ...
    if is_train: # Zero gradients.
        ...
        valueLayer_optimizer.zero_grad()
    ...
    if is_train:
        ...
        valueLayer_optimizer.step()

    return record


class ClassificationQUESTValue(algorithm.Algorithm):
    ...
    def process_batch_classification_task(self, batch, is_train):
        ...
        record = object_classification_with_quest(
            ...
            vector_quantizer_target=vector_quantizer_target,
            valueLayer=self.networks.get('valueLayer'),
            valueLayer_optimizer=self.optimizers.get('valueLayer'),

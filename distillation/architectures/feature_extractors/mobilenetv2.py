...
def mobilenetv2_T_w(T, W, feature_dim=100, input_size=32):
    model = MobileNetV2(T=T, feature_dim=feature_dim, input_size=input_size, width_mult=W)
    return model


def mobile_half(num_classes,input_size):
    return mobilenetv2_T_w(6, 0.5, num_classes, input_size)

def create_model(opt):
    num_classes = opt['num_classes']
    input_size = opt.get('input_size', 32)
    return mobile_half(num_classes=num_classes, input_size=input_size)

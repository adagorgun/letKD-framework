...
centers_filename =  f'./experiments/LDA/CIFAR100/WRN/WRN40w2_downscale/centers_subclass_{int(num_subclasses/num_classes)}_60.npy'
lda_filename = './experiments/LDA/CIFAR100/WRN/WRN40w2_downscale/lda_model'
scores_filename = f'./experiments/LDA/CIFAR100/WRN/WRN40w2_downscale/final_scores_{int(num_subclasses/num_classes)}_60.npy'



pretrained_VQ = f'./experiments/VQ/CIFAR100/WRN/WRN40w2_downscale/vector_quantizer_kmeansK{num_embeddings}_net_epoch{num_epochs}'

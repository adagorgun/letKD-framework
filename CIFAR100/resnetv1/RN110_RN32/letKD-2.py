...
centers_filename =  f'./experiments/LDA/CIFAR100/resnetv1/RN110/centers_subclass_{int(num_subclasses/num_classes)}.npy'
lda_filename = './experiments/LDA/CIFAR100/resnetv1/RN110/lda_model'
scores_filename = f'./experiments/LDA/CIFAR100/resnetv1/RN110/final_scores_{int(num_subclasses/num_classes)}.npy'


pretrained_VQ = f'./experiments/VQ/CIFAR100/resnetv1/RN110/vector_quantizer_kmeansK{num_embeddings}_net_epoch{num_epochs}'
